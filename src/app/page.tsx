    ...
    <main className="relative">
      ...
      <section id="developers" className="py-24 px-6">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">For Developers</h2>
            <p className="text-lg text-muted-foreground mb-12">Build with calm technology principles and local-first architecture.</p>
          </div>
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="space-y-4">
              {['Latency = Mindflow', 'Minimal UI = Inner calm'].map((item) => (
            ...
            <div className="space-y-4">
              {['Local data = Self-ownership', 'Deterministic prompts (JSON schemas)'].map((item) => (
                <div key={item} className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-accent rounded-full" />
                  <span className="text-foreground font-medium">{item}</span>
                </div>
      ...
      <section id="investors" className="py-24 px-6 bg-card/20">
        <div className="container mx-auto max-w-4xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">For Investors</h2>
            <p className="text-lg text-muted-foreground mb-12">Mirror framework, not attention engine. Profit through peace, scaled thoughtfully.</p>
          </div>
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="space-y-4">
              {['Mirror framework, not attention engine', 'GTM: Freemium Web → Offline Runtime'].map((item) => (
                <div key={item} className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-accent rounded-full" />
                  <span className="text-foreground font-medium">{item}</span>
                </div>
            ...
            <div className="space-y-4">
              {['Moat: Two-mind model + privacy covenant', 'Profit = Peace, Scaled'].map((item) => (
                <div key={item} className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-accent rounded-full" />
                  <span className="text-foreground font-medium">{item}</span>
                </div>
      ...
      <section id="believers" className="py-24 px-6">
        <div className="container mx-auto max-w-4xl text-center">
          <div className="mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">For Believers</h2>
            <p className="text-lg text-muted-foreground mb-12">Technology as a return to self-awareness and authentic intelligence.</p>
          </div>
          <div className="space-y-8 mb-16">
            {[
              ...
              <blockquote key={quote} className="text-xl md:text-2xl font-medium text-foreground">{quote}</blockquote>
            ))}
          </div>
          <Link href="/believers">
      ...
      <section id="users" className="py-24 px-6 bg-card/20">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">For Users</h2>
            <p className="text-lg text-muted-foreground mb-12">Experience the dialogue between ARC-0 and ARC-1 as they generate insights.</p>
          </div>
          <SparkCycler />
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-16">
            ...
            <a
              href="/manifesto.pdf"
              download
              className="px-6 py-3 border border-border text-foreground rounded-xl font-medium hover:bg-card hover:border-accent/50 transition-colors text-center"
            >
              Download Manifesto
            </a>
          </div>
      ...
      <section id="reach-me" className="py-24 px-6">
        <div className="container mx-auto max-w-2xl">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">Reach Me</h2>
            <p className="text-lg text-muted-foreground">
              Whether you&apos;re an investor, visionary, or builder — let&apos;s explore the potential together.
            </p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-6 bg-card/30 p-8 rounded-xl border border-border">
            <div>
            ...
            <div className="flex items-start gap-3">
              <input
                ...
                onChange={(e) => setFormState({ ...formState, license: e.target.checked })}
              ...
              <label htmlFor="license-agreement" className="text-sm text-muted-foreground">
                I agree to the{' '}
                <a href="/license" className="text-accent hover:underline">ARC-Reflective Use License</a>
              </label>
            </div>
