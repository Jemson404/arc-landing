...
const SOCIAL_LINKS = [
  {
    name: 'WhatsApp',
    href: 'https://wa.me/14373666101',
    Icon: WhatsAppIcon,
  },
  {
    name: 'LinkedIn',
    href: 'https://www.linkedin.com/in/albira-rahman-jemson404',
    Icon: Linkedin,
  },
  {
    name: 'Instagram',
    href: 'https://www.instagram.com/jason_got_no_chill',
    Icon: Instagram,
  },
  {
    name: 'Facebook',
    href: 'https://www.facebook.com/simple.di.oxyde',
    Icon: Facebook,
  },
]
...
export default function SocialDock() {
  ...
  // Keep the form-success page distraction-free
